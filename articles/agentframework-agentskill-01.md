---
title: Microsoft Agents Framework の Agent Skills 入門 - C# サンプルから学ぶ 3 つの実装パターン
emoji: "🧠"
type: tech
...
今回の記事では、MyAFSamples の Sample12AgentSkillConsoleApp を題材に、Agent Skills を使った知識付与の実装を解説します。  
このサンプルは、次の 3 パターンを 1 つのアプリで比較できるのがポイントです。
...
Agent Skills は、エージェントに対して「どの知識を、どんな役割で使わせるか」を明示する仕組みです。  
